...
void RosMsgReceiver::initialize()
{
    ...
    RelocSub = node.subscribe("CNActuator/VisionRelocTrigger", 1, &RosMsgReceiver::handleVisionRelocTriggerMessage, this);
...
void RosMsgReceiver::handleVisionRelocTriggerMessage(const msl_actuator_msgs::VisionRelocTrigger::ConstPtr &msg)
{
	auto tmpID = supplementary::SystemConfig::getOwnRobotID();
